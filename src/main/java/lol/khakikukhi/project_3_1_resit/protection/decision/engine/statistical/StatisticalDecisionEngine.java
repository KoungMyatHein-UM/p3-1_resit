...
import lol.khakikukhi.project_3_1_resit.protection.decision.engine.statistical.latency.RollingContainer;
...
public class StatisticalDecisionEngine extends CoreDecisionEngine {
    ...
    private final Map<String, RollingContainer> endpointLatencies = new ConcurrentHashMap<>();
